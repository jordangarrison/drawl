...
graphviz/dot concern. The mermaid C4 backend treats element
containers as =System_Boundary= and routes edges visually without an
equivalent of =ltail=/=lhead=; the mermaid emitter (planned for v0.2)
emits plain element-to-element edges and lets mermaid handle
boundary clipping.
