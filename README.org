...
Try it in the browser: [[https://drawl.jordangarrison.dev][drawl.jordangarrison.dev]].
...
- =nixosModules.default= — =services.drawl= with optional nginx + ACME wrapper.
...
Live deployment: [[https://drawl.jordangarrison.dev][drawl.jordangarrison.dev]] runs from this exact module behind a Cloudflare Tunnel — see =nix/module.nix= for the option surface.
